...
emoji_dist={
    ...
    2: cur_path+"./emojis/disgust.png",
    2: cur_path+"./emojis/fear.png",
...
def show_subject():
    ...
    bounding_box = cv2.CascadeClassifier('E:/Program_Files/Python/Lib/site-packages/opencv/data/haarcascades/haarcascade_frontalface_default.xml')
...
if __name__ == '__main__':
    ...
    lmain.place(x=20, y=250)
    lmain3.pack()
    lmain3.place(x=500, y=180)
    lmain2.pack(side=RIGHT)
    lmain2.place(x=420, y=250)

    root.title("Photo To Emoji")
    root.geometry("800x800+100+10")
    root['bg'] = 'black'
